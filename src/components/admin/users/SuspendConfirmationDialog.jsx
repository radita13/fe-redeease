...
export default function SuspendConfirmationDialog({ isOpen, user, onClose, onConfirm }) {
        ...
        <div className='flex items-start gap-4'>
          ...
          <div className='flex-1'>
            ...
            <p className='text-body-md text-on-surface-variant leading-relaxed font-semibold'>
              ...
              <span className='text-on-surface font-bold'>{user.name}</span> account? This action
              will permanently remove this user account from the system databases.
            </p>
          </div>
        </div>
